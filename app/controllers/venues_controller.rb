class VenuesController < ApplicationController
  ...
  def index
    ...
    @venues = @q.result(distinct: true).includes(:dishes, :bookmarks,
                                                 :neighborhood).page(params[:page]).per(10)
  ...
  def venue_params
    params.require(:venue).permit(:name, :neighborhood_id, :map_address)
  end
end
