class DishesController < ApplicationController
  ...
  def index
    ...
    @dishes = @q.result(:distinct => true).includes(:user, :venue, :cuisine, :bookmark).page(params[:page]).per(10)
  end
  ...
  def current_user_must_be_dish_user
    ...
    def dish_params
      params.require(:dish).permit(:name, :cuisine_id, :venue_id, :loved, :user_id)
    end
end
